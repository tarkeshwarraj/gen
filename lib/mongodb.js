...
const uri = process.env.MONGODB_URI || "mongodb+srv://vote_user:YvuGLTdUfQreOYs5@votecluster.fl2quyl.mongodb.net/?retryWrites=true&w=majority&appName=voteCluster";
const options = {};
